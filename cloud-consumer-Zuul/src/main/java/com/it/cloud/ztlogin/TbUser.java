...
public class TbUser implements Serializable{	
     ...
     */
    @Excel(name = "会员id",orderNum = "1",width = 25)
	private Long id;
     ...
     * @date 2018-11-08 10:59:32
     */
    @Excel(name = "会员昵称",orderNum = "2",width = 25)
     ...
     * @date 2018-11-08 10:59:32
     */
    @Excel(name = "手机号",orderNum = "3",width = 25)
     ...
     * @date 2018-11-08 10:59:32
     */
    @Excel(name = "用户等级",orderNum = "4",width = 25)
     ...
     * @date 2018-11-08 10:59:32
     */
    @Excel(name = "实名认证",orderNum = "5",width = 25)
     ...
     * @date 2018-11-08 10:59:32
     */
    @Excel(name = "证件号码",orderNum = "6",width = 25)
     ...
     * @date 2018-11-08 10:59:32
     */
    @Excel(name = "注册时间",orderNum = "7",exportFormat="yyyy-MM-dd HH:mm:ss",width = 25)
     ...
     * 一级推荐人ID
     */
    @Excel(name = "推荐人ID",orderNum = "8",width = 25)
...
//	private String payPasswod;
     ...
     * 用户状态 （0-可用，1-已禁用）
     */
    @Excel(name = "用户状态",orderNum = "9",width = 25)
     ...
     * 代理商星级（0，1，2，3，4，5）
     */
    @Excel(name = "代理商星级",orderNum = "10",width = 25)
     ...
     * 运营中心（0-不是，1-是）
     */
    @Excel(name = "运营中心",orderNum = "11",width = 25)
     ...
     * 推荐人昵称
     */
    @Excel(name = "推荐人昵称",orderNum = "12",width = 25)
    private String recomAlias;

    /**
     * 推荐人手机号
     */
    @Excel(name = "推荐人手机号",orderNum = "13",width = 25)
     ...
     * hpy代理商0是1不是
     */
    @Excel(name = "推荐人手机号",orderNum = "14",width = 25)
